...
def sel_cat(anno_file, sel_num, output_dir):
...
if __name__ == "__main__":
    sel_num = 70
    output_dir = './data/coco/annotations/70+10/'

    anno_file_train = './data/coco/annotations/instances_train2017.json'
    sel_cat(anno_file_train, sel_num, output_dir)

    anno_file_val = './data/coco/annotations/instances_val2017.json'
    sel_cat(anno_file_val, sel_num, output_dir)
